...
# Wundheilung
Dieses Kapitel bezieht sich auf das Buch [[attachments/Diemer_Praxis_der_medizinischen_Trainingstherapie_1_2_Wundheilung.pdf | Buch: Frank Diemer / Volker Sutor Praxis der medizinischen Trainingstherapie I]] und das Kapitel 1.2.2. *"Spezifische Therapie verschiedener Bindegewebe"/ Muskulatur S.69*.
## Einleitung
- 25 % aller Sportverletzungen sind Muskelverletzungen
- Muskelläsionen gibt es in 2 Formen 
	- **_Direkt_** (durch äußere Gewalteinwirkung)
		- Wird ein kontrahierter Muskel durch eine externe Kraft komprimiert, kommt es zu einer superfizialen Kontusion. Im nicht kontrahierten Zustand wird der Muskel gegen den Knochen gedrückt und die Traumatisierung findet in der Tiefe statt.
	- **Indirekt** (ohne äußere Gewalteinwirkung)
		- Verletzungen ohne äußere Krafteinwirkung werden durch exzentrische Momente des kontrahierten Muskels ausgelöst (z. B. Landen nach einem Sprung, Sprintbelastung, schnelle Richtungsänderungen, Schussbewegung beim Fußball). Es sind bevorzugt zweigelenkige Muskeln betroffen.

### Einteilung von Muskelläsionen (mod. Müller-Wohlfahrt et al. 2013)
| **Ursache** | **Impairment** | **Außmaße ** | **Subgruppe** |
|---|---|---|---|
| **indirekt (ohne Gegnerkontakt)** | funktionell (kein Befund im MRT) | Typ 1: Überlastung/ Ermüdung | Typ 1a: starke Ermüdung nach Belastung <br/>Typ 1b: Delayed Onset Muscle Soreness („Muskelkater“) |
| |  | Typ 2: neuromuskulär | Typ 2a: mit der Wirbelsäule assoziiert (Fazilitation der segmentalen Muskeln durch Funktionsstörung in der LWS oder den Beckengelenken) <br/>Typ 2b: reziproke Inhibition durch muskuläre Dysbalance |
| |  | Typ 3: partielle Ruptur | ==Typ 3a==: primäre (wenige) Faszikel betroffen <br/> ==Typ 3b==: sekundäre (mehrere) Faszikel betroffen |
| |  | Typ 4: totale Ruptur | kompletter Muskel- und/oder Sehnenabriss |
| **direkt (mit Gegnerkontakt)** | strukturell (Befund im MRT) |  | Quetschung des Muskels durch externe Kraft |
> [!info] Meine Verletzung scheint Typ 3a oder 3b zu sein. [[2022-11-26-Saturday|2022-11-26]]


### Heilungsdauer von Muskelverletzungen
| Art der Schädigung                | Entzündungsphase | Proliferationsphase                                                 | Remodellierungsphase |
|-----------------------------------|-------------------|---------------------------------------------------------------------|----------------------|
| Dehnung oder Kontusion (Grad 1–3) | ca. 2 Tage        | - 7–14 Tage kontraktile Komponente </br> - 14–21 Tage bindegewebige Narbe | ab der 3. Woche      |
## Medizinische Prozessbeschreibung der Wundheilung
- Direkt nach dem Trauma wird die entstandene Lücke durch das ==Hämatom ausgefüllt==
- ==Abtransport== der Zell- und Matrixtrümmer
- Aufbau eines Bands um die geschädigte Stelle
	- *Der unmittelbare Schadensbereich wird von den noch intakten Sarkomeren durch ein sogenanntes „Contraction Band“ abgetrennt. Ohne diese Versiegelung würden auch intakte Teile der Muskelzelle entfernt werden.*
- Verschont werden ebenfalls die noch bestehenden Anteile der Basallamina[^1]
- Nach dieser akuten Phase bildet sich im Zentrum des Schadens (zentrale Zone) die bindegewebige Narbe und in der Regenerationszone kommt es zur Neuorganisation des kontraktilen Apparats:

![Verschmelzung der Myoblasten zu Myotuben innerhalb der alten Basallamina des verletzten Muskels (Järvinen et al. 2005).](attachments/Pasted%20image%2020221126182011.png "Verschmelzung der Myoblasten zu Myotuben innerhalb der alten Basallamina des verletzten Muskels (Järvinen et al. 2005)" )
...
- Gerade die ==Betonung von exzentrischen Übungen== hat sich in der Nachbehandlung von Muskelverletzungen bewährt
